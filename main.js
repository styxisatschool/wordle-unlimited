...
this.wordle.bundle = function(e) {
    ...
    function Ga(e) {
        return Math.floor(Math.random() * 2315) % La.length;
    }
      ...
      , ts = function(e) {
        ...
        return o(t, [{
            ...
            value: function() {
                ...
                this.shadowRoot.getElementById("reset-button").addEventListener("click", (function(a) {
                    e.addToast("Reset");
                    console.log(Object.entries(e));
                    e.gameStatus = "IN_PROGRESS";
                    e.canInput = true;
                    while (e.rowIndex > 0) {
                      e.removeLetter();
                      e.removeLetter();
                    ...
                    e.letterEvaluations = {};
                    var rows = Array.from(e.$keyboard.shadowRoot.getElementById("keyboard").children);
                    for (var rowIdx in rows) {
                      var letters = Array.from(rows[rowIdx].children);
                      for (var letterIdx in letters) {
                        letters[letterIdx].removeAttribute("data-state");
                      }
                    };
                    e.boardState = new Array(6).fill("");
                    e.evaluations = new Array(6).fill(null);
